    ...
    return (
      <li>
        <div className='top'>     
          ...
          <button className='learnmore' onClick={() => this.props.learnLaw(law.lookup_cc)}><i className='fa fa-fw fa-info-circle'></i></button>
          <button className='watch' onClick={() => this.props.watchLaw(law.lookup_cc)}><i className='fa fa-fw fa-eye'></i></button>
        </div>
